...
const STATIC_ZH = {
  ...
  products: '内置产品',
  conflictTitle: '安装冲突',
  conflictDisabled: '已自动禁用内置产品 {name}，避免重复挂载。',
  conflictEnabled: '已重新启用内置产品 {name}。',
  conflictChanged: '内置产品 {name} 的状态已变更。',
  undoConflict: '撤销',
  conflictHint: '冲突动作由官方安装器在安装时自动执行，撤销会写回产品开关并在重启后生效。',
...
const STATIC_EN = {
  ...
  conflictDisabled: 'Built-in product {name} was automatically disabled to avoid double mounting.',
  conflictEnabled: 'Built-in product {name} was re-enabled.',
  conflictChanged: 'The state of built-in product {name} changed.',
  undoConflict: 'Undo',
  conflictHint: 'Conflict actions are applied by the official installer at install time; undoing writes the product switch back and applies after a restart.',
