	...
	factory: (require) => {
		...
		*/
		...
		var market_module_css_default = {
			...
			"spriteThumb": "bkhjFa_spriteThumb",
			"tab": "bkhjFa_tab",
						...
						children: [
							...
							failed ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
								...
								children: visible.map((item) => {
									...
									const spriteGrid = tab === "pet" && !item.previews?.length ? item.spriteGrid : void 0;
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
										className: market_module_css_default.card,
										children: [thumb ? spriteGrid?.columns && spriteGrid.rows ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: market_module_css_default.thumb + " " + market_module_css_default.spriteThumb,
