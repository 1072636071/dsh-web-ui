Create Codex pet row `running-right` for `whale-girl`: exactly 8 full-body frames in one horizontal strip on flat pure magenta #FF00FF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Q版萌系少女约2.5头身，蓝白海洋配色，鲸鱼尾裙摆尾鳍，头顶小喷泉呆毛，鱼鳍耳饰，软萌治愈性格. Preserve silhouette, face, palette, material, proportions, markings, and props.
