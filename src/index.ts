/**
 * @deepseek-ai/dsh-client-ui-git-graph — host half: the workspace-gated git
 ...
 * by client-modules from the same package's dshClient declaration.
 *
 ...
 * @module @deepseek-ai/dsh-client-ui-git-graph
 */
