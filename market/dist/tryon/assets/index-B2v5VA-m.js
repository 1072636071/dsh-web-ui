import{a as u,c9 as w,aR as b,ca as m,b7 as v,bh as g,bU as S,aU as E}from"./index-CQBdR3IH.js";import{F as R}from"./index-B-Ka8Hoj.js";import"./git-DJDr4heb.js";const N="web-app",U=E(new URL("../../../..",import.meta.url)),y="webRuntime",j=["webServer"],A=u.object({openBrowser:u.boolean().default(!0),printUrl:u.boolean().default(!0),surfaceContext:u.boolean().default(!0),trustedHosts:u.array(String).default([])}),h="DSH_WEB_URL",O="127.0.0.1",_="0.0.0.0";function L(e){const r=v(e);return["SSH_CONNECTION","SSH_TTY"].some(n=>{const t=r.getFrom(n,["process"])?.value;return t!==void 0&&t!==""})}const T=import.meta.resolve("open"),C=`
try {
